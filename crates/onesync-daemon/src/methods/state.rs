...
/// `state.backup`
pub async fn backup(_ctx: &DispatchCtx, _params: &Value) -> Result<Value, MethodError> {
    Err(MethodError::not_implemented("state.backup"))
}

/// `state.export`
pub async fn export(_ctx: &DispatchCtx, _params: &Value) -> Result<Value, MethodError> {
    Err(MethodError::not_implemented("state.export"))
}

/// `state.repair.permissions`
pub async fn repair_permissions(_ctx: &DispatchCtx, _params: &Value) -> Result<Value, MethodError> {
    Err(MethodError::not_implemented("state.repair.permissions"))
}

/// `state.compact.now`
pub async fn compact_now(_ctx: &DispatchCtx, _params: &Value) -> Result<Value, MethodError> {
